...
[G, M, u0] = getInitialConditions_Cartesian(T, a, e);

%Solve ODE
tic
opts = odeset('RelTol',1e-11,'AbsTol',1e-11);
[t,u]= ode113('diffBase_Cartesian', tspan, u0, opts);
toc

%Calculate coordinates and orbits
[x, y, r, theta, orbits] = getSolution_Cartesian(u);
